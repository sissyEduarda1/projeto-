  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.headerContainer}>
        <Image
          source={require('../views/img/fisio_perna.jpg')}
          style={styles.headerImage}
        />
        <Text style={styles.headerTitle}>Fisioterapia da perna</Text>
...
export default FisioterapiaPernaScreen;